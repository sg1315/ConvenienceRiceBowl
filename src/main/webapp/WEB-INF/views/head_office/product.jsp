...
<body>
    ...
    <div id="form">
        <div id="form-top">
            ...
            <div id="form-top-btn">
                <button id="productadd" data-bs-toggle="modal" data-bs-target="#staticBackdrop">상품추가</button>
            </div>
        </div>
        ...
        <script>
            ...
            document.querySelectorAll('#table1 tbody tr').forEach(row => {
                row.addEventListener('click', function() {
                    // 모달을 띄우기 위한 코드
                    var myModal = new bootstrap.Modal(document.getElementById('staticBackdrop-modify'));
                    myModal.show(); // 모달 열기
                });
            });
